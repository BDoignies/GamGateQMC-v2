...
{    
    ...
    if (line == 365) { return  3; }; // LowEPComptonModel::SampleSecondaries(365)
    if (line == 375) { return  4; }; // LowEPComptonModel::SampleSecondaries(375)
    if (line == 379) { return  5; }; // LowEPComptonModel::SampleSecondaries(379)
    if (line == 352) { return  6; }; // ShellData::SelectRandomShell(352)
    if (line == 540) { return  7; }; // EMDataSet::RandomSelect(540)
    if (line == 440) { return  8; }; // LowEPComptonModel::SampleSecondaries(440)
    if (line == 441) { return  9; }; // LowEPComptonModel::SampleSecondaries(441)
    if (line == 537) { return 10; }; // LowEPComptonModel::SampleSecondaries(537)
